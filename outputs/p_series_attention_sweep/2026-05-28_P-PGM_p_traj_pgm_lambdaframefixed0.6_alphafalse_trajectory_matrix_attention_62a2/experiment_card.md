...
- Run name: 2026-05-28_P-PGM_p_traj_pgm_lambdaframefixed0.6_alphafalse_trajectory_matrix_attention_62a2
- Date: 2026-05-28T16:28:29
- Ablation ID: P-PGM
...
-> TemporalProjection
-> U [B, T, 128]
-> GaussianFramePGMSmoother(lambda_frame = 0.6)
-> Z [B, T, 128]
...
| Metric | Value |
|---|---|
| best_val_top1 | 0.18654580152671757 |
| best_val_epoch | 35 |
| epochs_trained | 65 |
| early_stopped | True |
| stop_reason | no validation improvement for 30 epochs |
| final_train_loss | 1.186894954361252 |
| final_val_loss | 4.797338998954714 |
| final_train_top1 | 0.6222793702565389 |
| final_val_top1 | 0.15410305343511452 |
| test_top1 | null |

## Checkpoints

- best: C:\Users\ziyan\OneDrive\Desktop\PGM_project\outputs\p_series_attention_sweep\2026-05-28_P-PGM_p_traj_pgm_lambdaframefixed0.6_alphafalse_trajectory_matrix_attention_62a2\checkpoints\best.pt
- last: C:\Users\ziyan\OneDrive\Desktop\PGM_project\outputs\p_series_attention_sweep\2026-05-28_P-PGM_p_traj_pgm_lambdaframefixed0.6_alphafalse_trajectory_matrix_attention_62a2\checkpoints\last.pt

## Notes

- What worked:
- What failed:
- What to try next: Attention-head lambda sweep copied from P15_trajectory_matrix_linear_pgm_lam060.yaml. Same PGM placement/lambda as the source config; classifier is direct trajectory_matrix_attention over DiffNet relation tokens R. No InformationMatrixAccumulator.
