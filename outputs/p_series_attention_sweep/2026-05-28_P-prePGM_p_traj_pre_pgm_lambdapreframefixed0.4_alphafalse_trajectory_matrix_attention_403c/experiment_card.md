...
- Run name: 2026-05-28_P-prePGM_p_traj_pre_pgm_lambdapreframefixed0.4_alphafalse_trajectory_matrix_attention_403c
- Date: 2026-05-28T16:44:26
...
Pipeline:
X [B, T, 512]
-> GaussianFramePGMSmoother(pre, lambda_frame = 0.4)
-> X_smooth [B, T, 512]
-> TemporalProjection
-> U [B, T, 128]
...
| Metric | Value |
|---|---|
| best_val_top1 | 0.1875 |
| best_val_epoch | 29 |
| epochs_trained | 59 |
| early_stopped | True |
| stop_reason | no validation improvement for 30 epochs |
| final_train_loss | 1.2286139472712465 |
| final_val_loss | 4.76183387523389 |
| final_train_top1 | 0.6062221664680424 |
| final_val_top1 | 0.15648854961832062 |
| test_top1 | null |

## Checkpoints

- best: C:\Users\ziyan\OneDrive\Desktop\PGM_project\outputs\p_series_attention_sweep\2026-05-28_P-prePGM_p_traj_pre_pgm_lambdapreframefixed0.4_alphafalse_trajectory_matrix_attention_403c\checkpoints\best.pt
- last: C:\Users\ziyan\OneDrive\Desktop\PGM_project\outputs\p_series_attention_sweep\2026-05-28_P-prePGM_p_traj_pre_pgm_lambdapreframefixed0.4_alphafalse_trajectory_matrix_attention_403c\checkpoints\last.pt

## Notes

- What worked:
- What failed:
- What to try next: Attention-head lambda sweep copied from P13_prePGM_lam040_trajectory_matrix_linear.yaml. Same PGM placement/lambda as the source config; classifier is direct trajectory_matrix_attention over DiffNet relation tokens R. No InformationMatrixAccumulator.
