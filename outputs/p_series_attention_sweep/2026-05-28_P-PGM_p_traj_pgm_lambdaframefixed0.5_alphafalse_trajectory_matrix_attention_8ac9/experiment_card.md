...
- Run name: 2026-05-28_P-PGM_p_traj_pgm_lambdaframefixed0.5_alphafalse_trajectory_matrix_attention_8ac9
- Date: 2026-05-28T16:26:31
- Ablation ID: P-PGM
...
-> TemporalProjection
-> U [B, T, 128]
-> GaussianFramePGMSmoother(lambda_frame = 0.5)
-> Z [B, T, 128]
...
| Metric | Value |
|---|---|
| best_val_top1 | 0.1855916030534351 |
| best_val_epoch | 27 |
| epochs_trained | 57 |
| early_stopped | True |
| stop_reason | no validation improvement for 30 epochs |
| final_train_loss | 1.2996092098596546 |
| final_val_loss | 4.477849787428179 |
| final_train_top1 | 0.5872169604215016 |
| final_val_top1 | 0.16412213740458015 |
| test_top1 | null |

## Checkpoints

- best: C:\Users\ziyan\OneDrive\Desktop\PGM_project\outputs\p_series_attention_sweep\2026-05-28_P-PGM_p_traj_pgm_lambdaframefixed0.5_alphafalse_trajectory_matrix_attention_8ac9\checkpoints\best.pt
- last: C:\Users\ziyan\OneDrive\Desktop\PGM_project\outputs\p_series_attention_sweep\2026-05-28_P-PGM_p_traj_pgm_lambdaframefixed0.5_alphafalse_trajectory_matrix_attention_8ac9\checkpoints\last.pt

## Notes

- What worked:
- What failed:
- What to try next: Attention-head lambda sweep copied from P14_trajectory_matrix_linear_pgm_lam050.yaml. Same PGM placement/lambda as the source config; classifier is direct trajectory_matrix_attention over DiffNet relation tokens R. No InformationMatrixAccumulator.
