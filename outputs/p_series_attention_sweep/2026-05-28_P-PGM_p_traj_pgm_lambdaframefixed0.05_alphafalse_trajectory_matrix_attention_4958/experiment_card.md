...
- Run name: 2026-05-28_P-PGM_p_traj_pgm_lambdaframefixed0.05_alphafalse_trajectory_matrix_attention_4958
- Date: 2026-05-28T16:17:04
- Ablation ID: P-PGM
...
-> TemporalProjection
-> U [B, T, 128]
-> GaussianFramePGMSmoother(lambda_frame = 0.05)
-> Z [B, T, 128]
...
| Metric | Value |
|---|---|
| best_val_top1 | 0.17938931297709923 |
| best_val_epoch | 22 |
| epochs_trained | 52 |
| early_stopped | True |
| stop_reason | no validation improvement for 30 epochs |
| final_train_loss | 1.2567053070886667 |
| final_val_loss | 4.534565747239207 |
| final_train_top1 | 0.5988207990967823 |
| final_val_top1 | 0.16603053435114504 |
| test_top1 | null |

## Checkpoints

- best: C:\Users\ziyan\OneDrive\Desktop\PGM_project\outputs\p_series_attention_sweep\2026-05-28_P-PGM_p_traj_pgm_lambdaframefixed0.05_alphafalse_trajectory_matrix_attention_4958\checkpoints\best.pt
- last: C:\Users\ziyan\OneDrive\Desktop\PGM_project\outputs\p_series_attention_sweep\2026-05-28_P-PGM_p_traj_pgm_lambdaframefixed0.05_alphafalse_trajectory_matrix_attention_4958\checkpoints\last.pt

## Notes

- What worked:
- What failed:
- What to try next: Attention-head lambda sweep copied from P4_trajectory_matrix_linear_pgm_lam005.yaml. Same PGM placement/lambda as the source config; classifier is direct trajectory_matrix_attention over DiffNet relation tokens R. No InformationMatrixAccumulator.
