...
- Run name: 2026-05-28_P-PGM_p_traj_pgm_lambdaframefixed0.9_alphafalse_trajectory_matrix_attention_c556
- Date: 2026-05-28T16:33:59
- Ablation ID: P-PGM
...
-> TemporalProjection
-> U [B, T, 128]
-> GaussianFramePGMSmoother(lambda_frame = 0.9)
-> Z [B, T, 128]
...
| final_train_loss | 1.195797674757455 |
| final_val_loss | 4.766635967574957 |
| final_train_top1 | 0.6160070250266575 |
| final_val_top1 | 0.1650763358778626 |
| test_top1 | null |

## Checkpoints

- best: C:\Users\ziyan\OneDrive\Desktop\PGM_project\outputs\p_series_attention_sweep\2026-05-28_P-PGM_p_traj_pgm_lambdaframefixed0.9_alphafalse_trajectory_matrix_attention_c556\checkpoints\best.pt
- last: C:\Users\ziyan\OneDrive\Desktop\PGM_project\outputs\p_series_attention_sweep\2026-05-28_P-PGM_p_traj_pgm_lambdaframefixed0.9_alphafalse_trajectory_matrix_attention_c556\checkpoints\last.pt

## Notes

- What worked:
- What failed:
- What to try next: Attention-head lambda sweep copied from P18_trajectory_matrix_linear_pgm_lam090.yaml. Same PGM placement/lambda as the source config; classifier is direct trajectory_matrix_attention over DiffNet relation tokens R. No InformationMatrixAccumulator.
