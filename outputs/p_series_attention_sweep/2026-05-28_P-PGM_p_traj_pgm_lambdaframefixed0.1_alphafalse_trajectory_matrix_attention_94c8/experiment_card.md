...
- Run name: 2026-05-28_P-PGM_p_traj_pgm_lambdaframefixed0.1_alphafalse_trajectory_matrix_attention_94c8
- Date: 2026-05-28T16:19:09
- Ablation ID: P-PGM
...
-> TemporalProjection
-> U [B, T, 128]
-> GaussianFramePGMSmoother(lambda_frame = 0.1)
-> Z [B, T, 128]
...
| Metric | Value |
|---|---|
| best_val_top1 | 0.17986641221374045 |
| best_val_epoch | 38 |
| epochs_trained | 68 |
| early_stopped | True |
| stop_reason | no validation improvement for 30 epochs |
| final_train_loss | 0.989294775152329 |
| final_val_loss | 5.419121563889598 |
| final_train_top1 | 0.6769742206611052 |
| final_val_top1 | 0.14646946564885496 |
| test_top1 | null |

## Checkpoints

- best: C:\Users\ziyan\OneDrive\Desktop\PGM_project\outputs\p_series_attention_sweep\2026-05-28_P-PGM_p_traj_pgm_lambdaframefixed0.1_alphafalse_trajectory_matrix_attention_94c8\checkpoints\best.pt
- last: C:\Users\ziyan\OneDrive\Desktop\PGM_project\outputs\p_series_attention_sweep\2026-05-28_P-PGM_p_traj_pgm_lambdaframefixed0.1_alphafalse_trajectory_matrix_attention_94c8\checkpoints\last.pt

## Notes

- What worked:
- What failed:
- What to try next: Attention-head lambda sweep copied from P5_trajectory_matrix_linear_pgm_lam010.yaml. Same PGM placement/lambda as the source config; classifier is direct trajectory_matrix_attention over DiffNet relation tokens R. No InformationMatrixAccumulator.
