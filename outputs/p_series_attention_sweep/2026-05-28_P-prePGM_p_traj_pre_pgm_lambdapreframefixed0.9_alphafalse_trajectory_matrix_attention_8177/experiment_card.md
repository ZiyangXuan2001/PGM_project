...
- Run name: 2026-05-28_P-prePGM_p_traj_pre_pgm_lambdapreframefixed0.9_alphafalse_trajectory_matrix_attention_8177
- Date: 2026-05-28T16:54:29
...
Pipeline:
X [B, T, 512]
-> GaussianFramePGMSmoother(pre, lambda_frame = 0.9)
-> X_smooth [B, T, 512]
-> TemporalProjection
-> U [B, T, 128]
...
| Metric | Value |
|---|---|
| best_val_top1 | 0.1808206106870229 |
| best_val_epoch | 48 |
| epochs_trained | 78 |
| early_stopped | True |
| stop_reason | no validation improvement for 30 epochs |
| final_train_loss | 0.9790799266637168 |
| final_val_loss | 5.283104528907601 |
| final_train_top1 | 0.6835601831524807 |
| final_val_top1 | 0.16698473282442747 |
| test_top1 | null |

## Checkpoints

- best: C:\Users\ziyan\OneDrive\Desktop\PGM_project\outputs\p_series_attention_sweep\2026-05-28_P-prePGM_p_traj_pre_pgm_lambdapreframefixed0.9_alphafalse_trajectory_matrix_attention_8177\checkpoints\best.pt
- last: C:\Users\ziyan\OneDrive\Desktop\PGM_project\outputs\p_series_attention_sweep\2026-05-28_P-prePGM_p_traj_pre_pgm_lambdapreframefixed0.9_alphafalse_trajectory_matrix_attention_8177\checkpoints\last.pt

## Notes

- What worked:
- What failed:
- What to try next: Attention-head lambda sweep copied from P24_prePGM_lam090_trajectory_matrix_linear.yaml. Same PGM placement/lambda as the source config; classifier is direct trajectory_matrix_attention over DiffNet relation tokens R. No InformationMatrixAccumulator.
