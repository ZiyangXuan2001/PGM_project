...
- Run name: 2026-05-28_P-prePGM_p_traj_pre_pgm_lambdapreframefixed1.0_alphafalse_trajectory_matrix_attention_c89b
- Date: 2026-05-28T16:56:46
...
Pipeline:
X [B, T, 512]
-> GaussianFramePGMSmoother(pre, lambda_frame = 1.0)
-> X_smooth [B, T, 512]
-> TemporalProjection
-> U [B, T, 128]
...
| Metric | Value |
|---|---|
| best_val_top1 | 0.18416030534351144 |
| best_val_epoch | 45 |
| epochs_trained | 75 |
| early_stopped | True |
| stop_reason | no validation improvement for 30 epochs |
| final_train_loss | 1.0281919341669667 |
| final_val_loss | 5.162402651692164 |
| final_train_top1 | 0.6646804240105375 |
| final_val_top1 | 0.16269083969465647 |
| test_top1 | null |

## Checkpoints

- best: C:\Users\ziyan\OneDrive\Desktop\PGM_project\outputs\p_series_attention_sweep\2026-05-28_P-prePGM_p_traj_pre_pgm_lambdapreframefixed1.0_alphafalse_trajectory_matrix_attention_c89b\checkpoints\best.pt
- last: C:\Users\ziyan\OneDrive\Desktop\PGM_project\outputs\p_series_attention_sweep\2026-05-28_P-prePGM_p_traj_pre_pgm_lambdapreframefixed1.0_alphafalse_trajectory_matrix_attention_c89b\checkpoints\last.pt

## Notes

- What worked:
- What failed:
- What to try next: Attention-head lambda sweep copied from P25_prePGM_lam100_trajectory_matrix_linear.yaml. Same PGM placement/lambda as the source config; classifier is direct trajectory_matrix_attention over DiffNet relation tokens R. No InformationMatrixAccumulator.
