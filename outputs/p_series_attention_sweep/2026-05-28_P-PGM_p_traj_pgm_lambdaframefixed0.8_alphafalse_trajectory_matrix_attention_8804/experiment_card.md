...
- Run name: 2026-05-28_P-PGM_p_traj_pgm_lambdaframefixed0.8_alphafalse_trajectory_matrix_attention_8804
- Date: 2026-05-28T16:32:00
- Ablation ID: P-PGM
...
-> TemporalProjection
-> U [B, T, 128]
-> GaussianFramePGMSmoother(lambda_frame = 0.8)
-> Z [B, T, 128]
...
| Metric | Value |
|---|---|
| best_val_top1 | 0.18129770992366412 |
| best_val_epoch | 29 |
| epochs_trained | 59 |
| early_stopped | True |
| stop_reason | no validation improvement for 30 epochs |
| final_train_loss | 1.2999037638113144 |
| final_val_loss | 4.478650264157594 |
| final_train_top1 | 0.5872169604215016 |
| final_val_top1 | 0.1765267175572519 |
| test_top1 | null |

## Checkpoints

- best: C:\Users\ziyan\OneDrive\Desktop\PGM_project\outputs\p_series_attention_sweep\2026-05-28_P-PGM_p_traj_pgm_lambdaframefixed0.8_alphafalse_trajectory_matrix_attention_8804\checkpoints\best.pt
- last: C:\Users\ziyan\OneDrive\Desktop\PGM_project\outputs\p_series_attention_sweep\2026-05-28_P-PGM_p_traj_pgm_lambdaframefixed0.8_alphafalse_trajectory_matrix_attention_8804\checkpoints\last.pt

## Notes

- What worked:
- What failed:
- What to try next: Attention-head lambda sweep copied from P17_trajectory_matrix_linear_pgm_lam080.yaml. Same PGM placement/lambda as the source config; classifier is direct trajectory_matrix_attention over DiffNet relation tokens R. No InformationMatrixAccumulator.
