...
- Run name: 2026-05-28_P-PGM_p_traj_pgm_lambdaframefixed0.4_alphafalse_trajectory_matrix_attention_4fbe
- Date: 2026-05-28T16:24:47
- Ablation ID: P-PGM
...
-> TemporalProjection
-> U [B, T, 128]
-> GaussianFramePGMSmoother(lambda_frame = 0.4)
-> Z [B, T, 128]
...
| Metric | Value |
|---|---|
| best_val_top1 | 0.18606870229007633 |
| best_val_epoch | 35 |
| epochs_trained | 65 |
| early_stopped | True |
| stop_reason | no validation improvement for 30 epochs |
| final_train_loss | 1.1408153618547747 |
| final_val_loss | 4.8683290117569555 |
| final_train_top1 | 0.6326287398858433 |
| final_val_top1 | 0.15935114503816794 |
| test_top1 | null |

## Checkpoints

- best: C:\Users\ziyan\OneDrive\Desktop\PGM_project\outputs\p_series_attention_sweep\2026-05-28_P-PGM_p_traj_pgm_lambdaframefixed0.4_alphafalse_trajectory_matrix_attention_4fbe\checkpoints\best.pt
- last: C:\Users\ziyan\OneDrive\Desktop\PGM_project\outputs\p_series_attention_sweep\2026-05-28_P-PGM_p_traj_pgm_lambdaframefixed0.4_alphafalse_trajectory_matrix_attention_4fbe\checkpoints\last.pt

## Notes

- What worked:
- What failed:
- What to try next: Attention-head lambda sweep copied from P10_trajectory_matrix_linear_pgm_lam040.yaml. Same PGM placement/lambda as the source config; classifier is direct trajectory_matrix_attention over DiffNet relation tokens R. No InformationMatrixAccumulator.
