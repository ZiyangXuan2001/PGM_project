...
- Run name: 2026-05-28_P-PGM_p_traj_pgm_lambdaframefixed0.2_alphafalse_trajectory_matrix_attention_0f9e
- Date: 2026-05-28T16:21:07
- Ablation ID: P-PGM
...
-> TemporalProjection
-> U [B, T, 128]
-> GaussianFramePGMSmoother(lambda_frame = 0.2)
-> Z [B, T, 128]
...
| final_train_loss | 1.0737001061521763 |
| final_val_loss | 5.1975374585799585 |
| final_train_top1 | 0.6557736937841059 |
| final_val_top1 | 0.14456106870229007 |
| test_top1 | null |

## Checkpoints

- best: C:\Users\ziyan\OneDrive\Desktop\PGM_project\outputs\p_series_attention_sweep\2026-05-28_P-PGM_p_traj_pgm_lambdaframefixed0.2_alphafalse_trajectory_matrix_attention_0f9e\checkpoints\best.pt
- last: C:\Users\ziyan\OneDrive\Desktop\PGM_project\outputs\p_series_attention_sweep\2026-05-28_P-PGM_p_traj_pgm_lambdaframefixed0.2_alphafalse_trajectory_matrix_attention_0f9e\checkpoints\last.pt

## Notes

- What worked:
- What failed:
- What to try next: Attention-head lambda sweep copied from P8_trajectory_matrix_linear_pgm_lam020.yaml. Same PGM placement/lambda as the source config; classifier is direct trajectory_matrix_attention over DiffNet relation tokens R. No InformationMatrixAccumulator.
