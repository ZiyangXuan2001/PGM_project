...
- Run name: 2026-05-28_P-PGM_p_traj_pgm_lambdaframefixed1.0_alphafalse_trajectory_matrix_attention_7e9e
- Date: 2026-05-28T16:35:43
- Ablation ID: P-PGM
...
-> TemporalProjection
-> U [B, T, 128]
-> GaussianFramePGMSmoother(lambda_frame = 1.0)
-> Z [B, T, 128]
...
| Metric | Value |
|---|---|
| best_val_top1 | 0.1827290076335878 |
| best_val_epoch | 27 |
| epochs_trained | 57 |
| early_stopped | True |
| stop_reason | no validation improvement for 30 epochs |
| final_train_loss | 1.3457555215615802 |
| final_val_loss | 4.238010057056223 |
| final_train_top1 | 0.5726651194881767 |
| final_val_top1 | 0.17557251908396945 |
| test_top1 | null |

## Checkpoints

- best: C:\Users\ziyan\OneDrive\Desktop\PGM_project\outputs\p_series_attention_sweep\2026-05-28_P-PGM_p_traj_pgm_lambdaframefixed1.0_alphafalse_trajectory_matrix_attention_7e9e\checkpoints\best.pt
- last: C:\Users\ziyan\OneDrive\Desktop\PGM_project\outputs\p_series_attention_sweep\2026-05-28_P-PGM_p_traj_pgm_lambdaframefixed1.0_alphafalse_trajectory_matrix_attention_7e9e\checkpoints\last.pt

## Notes

- What worked:
- What failed:
- What to try next: Attention-head lambda sweep copied from P19_trajectory_matrix_linear_pgm_lam100.yaml. Same PGM placement/lambda as the source config; classifier is direct trajectory_matrix_attention over DiffNet relation tokens R. No InformationMatrixAccumulator.
