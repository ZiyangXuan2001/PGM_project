...
- Run name: 2026-05-28_P-prePGM_p_traj_pre_pgm_lambdapreframefixed0.6_alphafalse_trajectory_matrix_attention_a039
- Date: 2026-05-28T16:48:23
...
Pipeline:
X [B, T, 512]
-> GaussianFramePGMSmoother(pre, lambda_frame = 0.6)
-> X_smooth [B, T, 512]
-> TemporalProjection
-> U [B, T, 128]
...
| Metric | Value |
|---|---|
| best_val_top1 | 0.191793893129771 |
| best_val_epoch | 36 |
| epochs_trained | 66 |
| early_stopped | True |
| stop_reason | no validation improvement for 30 epochs |
| final_train_loss | 1.145211352560561 |
| final_val_loss | 4.818810954348732 |
| final_train_top1 | 0.6361412532145769 |
| final_val_top1 | 0.16698473282442747 |
| test_top1 | null |

## Checkpoints

- best: C:\Users\ziyan\OneDrive\Desktop\PGM_project\outputs\p_series_attention_sweep\2026-05-28_P-prePGM_p_traj_pre_pgm_lambdapreframefixed0.6_alphafalse_trajectory_matrix_attention_a039\checkpoints\best.pt
- last: C:\Users\ziyan\OneDrive\Desktop\PGM_project\outputs\p_series_attention_sweep\2026-05-28_P-prePGM_p_traj_pre_pgm_lambdapreframefixed0.6_alphafalse_trajectory_matrix_attention_a039\checkpoints\last.pt

## Notes

- What worked:
- What failed:
- What to try next: Attention-head lambda sweep copied from P21_prePGM_lam060_trajectory_matrix_linear.yaml. Same PGM placement/lambda as the source config; classifier is direct trajectory_matrix_attention over DiffNet relation tokens R. No InformationMatrixAccumulator.
